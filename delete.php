...
$form_data = array();
//Validarea formei de delete, in cazurile specificate. Ajax call-ul va fi va avea success=false; In caz cotrat trimite obiectul JSON pentru ajax call de success.
